...
my @testcases = (
    { filename => 'rtcpan.rdf',
      ...
      exp_partial => [
          ...
          sh(id => 'https://rt.cpan.org/Ticket/Display.html?id=84118',
          ...
          sh( id => 'https://rt.cpan.org/Ticket/Display.html?id=84187',
              ...
              user => sh( screen_name => q{rt.cpan.org: Search Queue = 'future'} )),
          sh( id => 'https://rt.cpan.org/Ticket/Display.html?id=84188',
              ...
              user => sh( screen_name => q{rt.cpan.org: Search Queue = 'future'} )),
          sh( id => 'https://rt.cpan.org/Ticket/Display.html?id=84189',
    ...
    { filename => 'slashdot.rss',
      ...
      exp_partial => [
          ## use <guid> for id
          sh( id => 'http://slashdot.feedsportal.com/c/35028/f/647410/s/3c35f940/sc/38/l/0Lhardware0Bslashdot0Borg0Cstory0C140C0A70C0A60C0A0A392340Cby0E20A450Ethe0Etop0Especies0Ewill0Eno0Elonger0Ebe0Ehumans0Eand0Ethat0Ecould0Ebe0Ea0Eproblem0Dutm0Isource0Frss10B0Amainlinkanon0Gutm0Imedium0Ffeed/story01.htm',,
          ...
          sh( id => 'http://slashdot.feedsportal.com/c/35028/f/647410/s/3c35c953/sc/32/l/0Lscience0Bslashdot0Borg0Cstory0C140C0A70C0A60C0A0A42540Ctwo0Eearth0Elike0Eexoplanets0Edont0Eactually0Eexist0Dutm0Isource0Frss10B0Amainlinkanon0Gutm0Imedium0Ffeed/story01.htm',
    ...
    { filename => 'stackoverflow.atom',
      exp_num => 30,
      exp_partial => [
          sh( id => 'http://stackoverflow.com/q/24593005',
          ...
          sh( id => 'http://stackoverflow.com/q/24593002',
    ...
    { filename => 'googlejp.atom',
      exp_num => 25,
      exp_partial => [
          sh( id => 'tag:blogger.com,1999:blog-20042392.post-2515664455683743324',
    ...
    { filename => 'slashdotjp.rdf',
      exp_num => 13,
      exp_partial => [
          sh( id => 'http://linux.slashdot.jp/story/14/07/09/097242/',
          ...
          sh( id => 'http://yro.slashdot.jp/story/14/07/09/0533213/',
